...
import { SoftModernUI } from './shared/SoftModernUI';

/**
 * Soft Modern Template
 * Friendly, calm, pastel design for personal apps and solopreneurs
 */

interface SoftModernThemeProps {
    config: SiteConfig;
}

export function SoftModernTheme({ config }: SoftModernThemeProps) {
    ...
    return (
        <div className='mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-lg mt-16'>
            ...
            <Link
                ...
                className='inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:shadow-xl'
